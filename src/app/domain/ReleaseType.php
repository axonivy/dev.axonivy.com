...
class ReleaseType
{
  ...
  public static function LTS(): ReleaseType
  {
    ...
    $type->headline = '<p>Get the latest stable <a href="/release-cycle" style="text-decoration:underline;font-weight:bold;">Long Term Support</a> version of the Axon Ivy Platform.';
    $type->banner = '';
