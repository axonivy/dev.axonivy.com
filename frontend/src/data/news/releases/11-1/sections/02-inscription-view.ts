      ...
      items: [
        {
          ...
          text: `The new inscription view runs on native web technologies.`,
        },
        {
          term: `View`,
          text: `Implemented as a View, our tool eliminates the need for pop-up dialogs and dynamically updates the content as you select different elements.`,
        },
        {
          term: `Immediate feedback`,
          text: `New technology, faster feedback - our goal is to enhance your user experience.`,
        },
        {
          term: `IvyScript editor`,
          text: `Experience IvyScript like never before with our use of the Monaco editor, complete with auto-completion and an improved writing interface.`,
        },
      ],
    },
  ],
